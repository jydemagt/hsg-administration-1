...
<div class="admin-hub-grid import-hub">
  ...
  <a class="admin-hub-card" href="supplier_upload.php"><span class="admin-hub-icon">⇧</span><span><strong>Leverandørfil</strong><small>Find priser, fadnummer, fadtype, ABV m.m. i forskellige Excel-filer og foreslå ændringer.</small></span><span class="admin-hub-arrow">›</span></a>
